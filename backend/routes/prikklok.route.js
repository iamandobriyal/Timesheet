...
router.get('/users', passport.authenticate('jwt', { session: false }), projectCtrl.project_users_get);

router.post('/update_events', passport.authenticate('jwt', { session: false }), accountingCtrl.update_events);

router.post('/remove_event', passport.authenticate('jwt', { session: false }), accountingCtrl.remove_event);

router.get('/get_events', passport.authenticate('jwt', { session: false }), eventCtrl.get_events);

router.get('/project_task', passport.authenticate('jwt', { session: false }), accountingCtrl.project_task);

router.post('/newproject', passport.authenticate('jwt', { session: false }), projectCtrl.new_project);

router.post('/addproject', passport.authenticate('jwt', { session: false }), projectCtrl.add_project);

router.post('/getproject', passport.authenticate('jwt', { session: false }), projectCtrl.get_project);

router.post('/update_project', passport.authenticate('jwt', { session: false }), projectCtrl.update_project);

router.post('/get_report', passport.authenticate('jwt', { session: false }), reportCtrl.get_report);

router.get('/analytics', passport.authenticate('jwt', { session: false }), reportCtrl.get_analytics);
...
router.get('/project/:id', passport.authenticate('jwt', { session: false }), projectCtrl.project_detail_get);


// get all the projects of a user
router.get('/projects', passport.authenticate('jwt', { session: false }), projectCtrl.project_list_get);

router.get('/allprojects', passport.authenticate('jwt', { session: false }), projectCtrl.all_projects);
